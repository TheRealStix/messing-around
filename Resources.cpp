...
Image* Sexy::IMAGE_FASTBUTTON_ACTIVE;
Image* Sexy::IMAGE_FASTBUTTON_ACTIVE_DOWN;
Image* Sexy::IMAGE_FASTBUTTON_ACTIVE_HIGHLIGHT;
Image* Sexy::IMAGE_FASTBUTTON_DOWN;
...
Image* Sexy::IMAGE_HD_PACKET_PLANTS;
...
Image* Sexy::IMAGE_SEEDCHOOSER_BUTTON_DISABLED_SMALL;
Image* Sexy::IMAGE_SEEDCHOOSER_BUTTON_FAV;
Image* Sexy::IMAGE_SEEDCHOOSER_BUTTON_FAV_ACTIVE;
Image* Sexy::IMAGE_SEEDCHOOSER_BUTTON_FAV_DISABLED;
Image* Sexy::IMAGE_SEEDCHOOSER_BUTTON_GLOW;
Image* Sexy::IMAGE_SEEDCHOOSER_BUTTON_GLOW_SMALL;
Image* Sexy::IMAGE_SEEDCHOOSER_BUTTON_SKIN;
Image* Sexy::IMAGE_SEEDCHOOSER_BUTTON_SKIN_DISABLED;
Image* Sexy::IMAGE_SEEDCHOOSER_BUTTON_SMALL;
Image* Sexy::IMAGE_SEEDCHOOSER_BUTTON_STAT;
Image* Sexy::IMAGE_SEEDCHOOSER_BUTTON_STAT_ACTIVE;
Image* Sexy::IMAGE_SEEDCHOOSER_GROUNDDAY;
Image* Sexy::IMAGE_SEEDCHOOSER_GROUNDNIGHT;
Image* Sexy::IMAGE_SEEDCHOOSER_GROUNDNIGHTPOOL;
Image* Sexy::IMAGE_SEEDCHOOSER_GROUNDPOOL;
Image* Sexy::IMAGE_SEEDCHOOSER_GROUNDROOF;
Image* Sexy::IMAGE_SEEDCHOOSER_IMITATERADDON;
Image* Sexy::IMAGE_SEEDCHOOSER_PLANTCARD;
...
Image* Sexy::IMAGE_UPGRADE_PACKET_PLANTS;
...
bool Sexy::ExtractLoadingImagesResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_FASTBUTTON_ACTIVE = aMgr.GetImageThrow("IMAGE_FASTBUTTON_ACTIVE");
		IMAGE_FASTBUTTON_ACTIVE_DOWN = aMgr.GetImageThrow("IMAGE_FASTBUTTON_ACTIVE_DOWN");
		IMAGE_FASTBUTTON_ACTIVE_HIGHLIGHT = aMgr.GetImageThrow("IMAGE_FASTBUTTON_ACTIVE_HIGHLIGHT");
		IMAGE_FASTBUTTON_DOWN = aMgr.GetImageThrow("IMAGE_FASTBUTTON_DOWN");
		...
		IMAGE_HD_PACKET_PLANTS = aMgr.GetImageThrow("IMAGE_HD_PACKET_PLANTS");
		...
		IMAGE_SEEDCHOOSER_BUTTON_DISABLED_SMALL = aMgr.GetImageThrow("IMAGE_SEEDCHOOSER_BUTTON_DISABLED_SMALL");
		IMAGE_SEEDCHOOSER_BUTTON_FAV = aMgr.GetImageThrow("IMAGE_SEEDCHOOSER_BUTTON_FAV");
		IMAGE_SEEDCHOOSER_BUTTON_FAV_ACTIVE = aMgr.GetImageThrow("IMAGE_SEEDCHOOSER_BUTTON_FAV_ACTIVE");
		IMAGE_SEEDCHOOSER_BUTTON_FAV_DISABLED = aMgr.GetImageThrow("IMAGE_SEEDCHOOSER_BUTTON_FAV_DISABLED");
		IMAGE_SEEDCHOOSER_BUTTON_GLOW = aMgr.GetImageThrow("IMAGE_SEEDCHOOSER_BUTTON_GLOW");
		IMAGE_SEEDCHOOSER_BUTTON_GLOW_SMALL = aMgr.GetImageThrow("IMAGE_SEEDCHOOSER_BUTTON_GLOW_SMALL");
		IMAGE_SEEDCHOOSER_BUTTON_SKIN = aMgr.GetImageThrow("IMAGE_SEEDCHOOSER_BUTTON_SKIN");
		IMAGE_SEEDCHOOSER_BUTTON_SKIN_DISABLED = aMgr.GetImageThrow("IMAGE_SEEDCHOOSER_BUTTON_SKIN_DISABLED");
		IMAGE_SEEDCHOOSER_BUTTON_SMALL = aMgr.GetImageThrow("IMAGE_SEEDCHOOSER_BUTTON_SMALL");
		IMAGE_SEEDCHOOSER_BUTTON_STAT = aMgr.GetImageThrow("IMAGE_SEEDCHOOSER_BUTTON_STAT");
		IMAGE_SEEDCHOOSER_BUTTON_STAT_ACTIVE = aMgr.GetImageThrow("IMAGE_SEEDCHOOSER_BUTTON_STAT_ACTIVE");
		IMAGE_SEEDCHOOSER_GROUNDDAY = aMgr.GetImageThrow("IMAGE_SEEDCHOOSER_GROUNDDAY");
		IMAGE_SEEDCHOOSER_GROUNDNIGHT = aMgr.GetImageThrow("IMAGE_SEEDCHOOSER_GROUNDNIGHT");
		IMAGE_SEEDCHOOSER_GROUNDNIGHTPOOL = aMgr.GetImageThrow("IMAGE_SEEDCHOOSER_GROUNDNIGHTPOOL");
		IMAGE_SEEDCHOOSER_GROUNDPOOL = aMgr.GetImageThrow("IMAGE_SEEDCHOOSER_GROUNDPOOL");
		IMAGE_SEEDCHOOSER_GROUNDROOF = aMgr.GetImageThrow("IMAGE_SEEDCHOOSER_GROUNDROOF");
		IMAGE_SEEDCHOOSER_IMITATERADDON = aMgr.GetImageThrow("IMAGE_SEEDCHOOSER_IMITATERADDON");
		IMAGE_SEEDCHOOSER_PLANTCARD = aMgr.GetImageThrow("IMAGE_SEEDCHOOSER_PLANTCARD");
		...
		IMAGE_UPGRADE_PACKET_PLANTS = aMgr.GetImageThrow("IMAGE_UPGRADE_PACKET_PLANTS");
...
static void* gResources[] =
{
	...
	&IMAGE_SEEDCHOOSER_GROUNDDAY,
	&IMAGE_SEEDCHOOSER_GROUNDNIGHT,
	&IMAGE_SEEDCHOOSER_GROUNDPOOL,
	&IMAGE_SEEDCHOOSER_GROUNDNIGHTPOOL,
	&IMAGE_SEEDCHOOSER_GROUNDROOF,
	&IMAGE_SEEDCHOOSER_BUTTON,
	&IMAGE_SEEDCHOOSER_BUTTON_DISABLED,
	&IMAGE_SEEDCHOOSER_BUTTON_GLOW,
	&IMAGE_SEEDCHOOSER_BUTTON_SMALL,
	&IMAGE_SEEDCHOOSER_BUTTON_DISABLED_SMALL,
	&IMAGE_SEEDCHOOSER_BUTTON_GLOW_SMALL,
	&IMAGE_SEEDCHOOSER_BUTTON_FAV,
	&IMAGE_SEEDCHOOSER_BUTTON_FAV_DISABLED,
	&IMAGE_SEEDCHOOSER_BUTTON_FAV_ACTIVE,
	&IMAGE_SEEDCHOOSER_BUTTON_SKIN,
	&IMAGE_SEEDCHOOSER_BUTTON_SKIN_DISABLED,
	&IMAGE_SEEDCHOOSER_BUTTON_STAT,
	&IMAGE_SEEDCHOOSER_BUTTON_STAT_ACTIVE,
	&IMAGE_SEEDCHOOSER_BUTTON2,
	&IMAGE_SEEDCHOOSER_BUTTON2_GLOW,
	&IMAGE_SEEDCHOOSER_IMITATERADDON,
	&IMAGE_SEEDCHOOSER_PLANTCARD,
	&IMAGE_SEEDS,
	&IMAGE_CONSOLE_SEEDS,
	...
	&IMAGE_FASTBUTTON,
	&IMAGE_FASTBUTTON_DOWN,
	&IMAGE_FASTBUTTON_HIGHLIGHT,
	&IMAGE_FASTBUTTON_ACTIVE,
	&IMAGE_FASTBUTTON_ACTIVE_DOWN,
	&IMAGE_FASTBUTTON_ACTIVE_HIGHLIGHT,
	&IMAGE_PRESENT,
	&IMAGE_PRESENTOPEN,
	...
	&IMAGE_TREEFOOD,
	&IMAGE_PACKET_PLANTS,
	&IMAGE_UPGRADE_PACKET_PLANTS,
	&IMAGE_HD_PACKET_PLANTS,
...
const char* Sexy::GetStringIdById(int theId)
{
	switch(theId)
	{
		...
		case IMAGE_SEEDCHOOSER_GROUNDDAY_ID: return "IMAGE_SEEDCHOOSER_GROUNDDAY";
		case IMAGE_SEEDCHOOSER_GROUNDNIGHT_ID: return "IMAGE_SEEDCHOOSER_GROUNDNIGHT";
		case IMAGE_SEEDCHOOSER_GROUNDPOOL_ID: return "IMAGE_SEEDCHOOSER_GROUNDPOOL";
		case IMAGE_SEEDCHOOSER_GROUNDNIGHTPOOL_ID: return "IMAGE_SEEDCHOOSER_GROUNDNIGHTPOOL";
		case IMAGE_SEEDCHOOSER_GROUNDROOF_ID: return "IMAGE_SEEDCHOOSER_GROUNDROOF";
		...
		case IMAGE_SEEDCHOOSER_BUTTON_SMALL_ID: return "IMAGE_SEEDCHOOSER_BUTTON_SMALL";
		case IMAGE_SEEDCHOOSER_BUTTON_DISABLED_SMALL_ID: return "IMAGE_SEEDCHOOSER_BUTTON_DISABLED_SMALL";
		case IMAGE_SEEDCHOOSER_BUTTON_GLOW_SMALL_ID: return "IMAGE_SEEDCHOOSER_BUTTON_GLOW_SMALL";
		case IMAGE_SEEDCHOOSER_BUTTON_FAV_ID: return "IMAGE_SEEDCHOOSER_BUTTON_FAV";
		case IMAGE_SEEDCHOOSER_BUTTON_FAV_DISABLED_ID: return "IMAGE_SEEDCHOOSER_BUTTON_FAV_DISABLED";
		case IMAGE_SEEDCHOOSER_BUTTON_FAV_ACTIVE_ID: return "IMAGE_SEEDCHOOSER_BUTTON_FAV_ACTIVE";
		case IMAGE_SEEDCHOOSER_BUTTON_SKIN_ID: return "IMAGE_SEEDCHOOSER_BUTTON_SKIN";
		case IMAGE_SEEDCHOOSER_BUTTON_SKIN_DISABLED_ID: return "IMAGE_SEEDCHOOSER_BUTTON_SKIN_DISABLED";
		case IMAGE_SEEDCHOOSER_BUTTON_STAT_ID: return "IMAGE_SEEDCHOOSER_BUTTON_STAT";
		case IMAGE_SEEDCHOOSER_BUTTON_STAT_ACTIVE_ID: return "IMAGE_SEEDCHOOSER_BUTTON_STAT_ACTIVE";
		...
		case IMAGE_SEEDCHOOSER_PLANTCARD_ID: return "IMAGE_SEEDCHOOSER_PLANTCARD";
		...
		case IMAGE_FASTBUTTON_DOWN_ID: return "IMAGE_FASTBUTTON_DOWN";
		case IMAGE_FASTBUTTON_HIGHLIGHT_ID: return "IMAGE_FASTBUTTON_HIGHLIGHT";
		case IMAGE_FASTBUTTON_ACTIVE_ID: return "IMAGE_FASTBUTTON_ACTIVE";
		case IMAGE_FASTBUTTON_ACTIVE_DOWN_ID: return "IMAGE_FASTBUTTON_ACTIVE_DOWN";
		case IMAGE_FASTBUTTON_ACTIVE_HIGHLIGHT_ID: return "IMAGE_FASTBUTTON_ACTIVE_HIGHLIGHT";
		...
		case IMAGE_UPGRADE_PACKET_PLANTS_ID: return "IMAGE_UPGRADE_PACKET_PLANTS";
		case IMAGE_HD_PACKET_PLANTS_ID: return "IMAGE_HD_PACKET_PLANTS";
